...
export default function Footer() {
  return (
    <footer className="w-full p-4 border-gray-400 text-white border-y-2 bg-gray-500 flex justify-between flex-col md:flex-row gap-4">
      ...
      <div className="flex flex-col text-end">
        <Link className="hover:bg-slate-300" href={"/"}>
          Home
        </Link>
        <Link className="hover:bg-slate-300" href={"/about-us"}>
          About Us
        </Link>
      </div>
    </footer>
