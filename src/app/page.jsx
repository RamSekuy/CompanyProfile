    ...
    <main className="w-full h-max">
      ...
      <section className="w-full border-y-2 border-green-400 bg-green-700 flex items-center justify-center py-4">
        <div className="w-[80%] text-justify text-white md:w-[50%] text-sm">
          <p>
            N0013 Company, Lorem ipsum, dolor sit amet consectetur adipisicing
            elit. Nihil quia, in expedita eum nisi asperiores minima. Culpa quos
            neque sint? Placeat at autem nulla inventore voluptates iure maxime
            itaque illo.
          </p>
        </div>
      </section>
